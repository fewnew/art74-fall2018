...
8 | Tue, 10/09 | **Lecture:** *Guest lecturer: Jorge Vizcaino* <br> **Lab:** Advanced Tutorials in Premiere Pro ↣ Topics related to Transitions, Effects, video stabilizing and color correction. <br> **Deliver:**   —
...
10 | Tue, 10/23 | **Lecture:** — <br> **Lab:** Intro to Three.js library and displaying 3D computer graphics in a web browser. <br> **Deliver:**  —
...
11 | Tue, 10/30 | **Lecture:** Web literacy (HTML/CSS/JavaScript) as a contemporary art form. <br> **Lab:** Intro to experimental generative 3D in the browser + HTML basics. <br> **Deliver:** Reading 07 //  in class discussion on the reading.
...
12 | Tue, 11/06 | **Lecture:**  — <br> **Lab:** Intro to web hosting directly from a GitHub repository + GitHub Pages. <br> **Deliver:**  —
