...
3 | Tue, 09/04 | **Lecture:** Vector vs. Raster <br> **Lab:** Intro to vector based image with Illustrator ↣ Topics on Illustrator workspace, vector graphic creation and editing controls. <br> **Deliver:** Assignment 03 (Stereograph).
...
4 | Tue, 09/11 | **Lecture:** Image manipulation <br> **Lab:** Tutorials on how to use PhotoMosh. <br> **Deliver:** Assignment 04 (Illustrations).
4 | Thu, 09/13 | **Lecture:** Micro Cinema // GIFs: modern day cinematographs **Lab:** Tutorials on how to use PhotoMosh. <br> **Deliver:** Assignment 04 (Digital Collage) Progress on Project 01 ↣ printed trigger image.
5 | Tue, 09/18 | **Field Trip** 
