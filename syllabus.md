...
1 | Thu, 08/23 | **Lecture:** Digital media art vs. new media art <br> **Lab:** Tutorials on how to use GitHub (version control, clone, commit). <br> **Deliver:** [Reading 01](https://github.com/fewnew/art74-fall2018/blob/master/Readings/reading01/Manovich%2C%20Lev%20-%20New%20Media%20from%20Borges%20to%20HTML(excerpt).pdf) // in class discussion on the reading.
...
4 | Thu, 09/13 | **Lecture:** Vector vs. raster <br> **Lab:** Intro to vector based image with Illustrator ↣ Topics on Illustrator workspace, vector graphic creation and editing controls. <br> **Deliver:** [Reading 03](https://github.com/fewnew/art74-fall2018/blob/master/Readings/reading03/Infographics_The_Power_of_Visual_Storytelling_----_(Chapter_03_The_Visual_Storytelling_Spectrum_An_Objective_Approach).pdf) //  in class discussion on the reading.
5 | Tue, 09/18 | **Lecture:** Guest artist: Victoria Scott <br> **Lab:** — <br> **Deliver:** Assignment 02 (Facet Art).
5 | Thu, 09/20 |  **Lecture:** — <br> **Lab:** Advanced Tutorials in Illustrator ↣ Topics related to advanced editing and manipulation features of graphics and images. <br> **Deliver:** [Reading 04](https://github.com/fewnew/art74-fall2018/blob/master/Readings/reading04/InvisibleVisualities.pdf) //  in class discussion on the reading.
...
7 | Thu, 10/04 | **Lecture:**  — <br> **Lab:** Intro to point of view, lighting, zoom and creative shooting techniques + Shooting. <br> **Deliver:** Assignment 03 (Storyboard).
...
9 | Tue, 10/16 | **Lecture:** Three-Dimensional Art: Form, volume and mass. <br> **Lab:**  Intro to photogrammetry ↣ 3D reality capture with ________? <br> **Deliver:** [Reading 06](https://github.com/fewnew/art74-fall2018/blob/master/Readings/reading06/The_3D_Additivist_Manifesto.pdf) //  in class discussion on the reading.
9 | Thu, 10/18 | **Lecture:**  — <br> **Lab:** Intro to 3D sculpting with MeshMixer ↣ Topics on mesh smoothing and free-form deformations, mesh simplification and repair. <br> **Deliver:** Assignment 04 (Fragment Collection).
...
11 | Thu, 11/01 | **Lecture:**  — <br> **Lab:** Intro to CSS and user interface design using color palettes, Google web fonts, Fontawesome iconography. <br> **Deliver:** Assignment 05 (Hyperlinked Narrative).
...
13 | Thu, 11/15 | **Lecture:** — <br> **Lab:** Advanced Tutorials in Processing ↣ Variables and response. <br> **Deliver:** [Reading 09](https://github.com/fewnew/art74-fall2018/blob/master/Readings/reading09/hello-processing.md) //  in class discussion on the reading
14 | Tue, 11/20 | **Lecture:** — <br> **Lab:** Advanced Tutorials in Processing (digging deeper into conditional statements) + Assigning groups. <br> **Deliver:** Assignment 06 (Basic Interactivity).
