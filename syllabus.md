...
4 | Tue, 09/11 | **Lecture:**  Micro Cinema // GIFs: modern day cinematographs <br> **Lab:** Tutorials on how to use PhotoMosh. <br> **Deliver:** Assignment 05 (Collage).
4 | Thu, 09/13 | **Field Trip** <br> **Deliver** Assignment 06 (Photomosh).
5 | Tue, 09/18 | **Lecture** Techniques at work in Mixed and Augmented Reality. <br> **Lab** Tutorials on how to use BlippAR. <br> **Deliver** Collage prints & [Reading 04](https://github.com/fewnew/art74-fall2018/blob/master/Readings/reading04/InvisibleVisualities.pdf) // in class discussion on the reading.
